...
public class Company extends Customer implements SameAmountToAll {
	...
	public Company(String name, String Address, int taxId, int userId) {
		super();
		this.name = name;
		this.id = userId;
		this.address = Address;
		this.taxIdNumber = taxId;

	}

	@Override
	public String toString() {
		return "[Name=" + getName() + ", Address= " + getAddress() + ", CustomerId= " + getId() + ", TaxId= "
				+ getTaxIdNumber() + "]";
	}
	...
	public void openCheckingAccount() {
		...
		System.out.println("The Savings Account (" + accountNum + ") is opened.");
		int checkNumber = companyCheckingAcc.nextCheck();
