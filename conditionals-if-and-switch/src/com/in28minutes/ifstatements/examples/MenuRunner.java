...
public class MenuRunner {
	...
	public static void main(String[] args) {
		// to take in an input from the user, use this function. System in is system
		// input
		// Type obj = new Type(argument);
		Scanner scanner = new Scanner(System.in);
		System.out.println("Enter Number1: ");
		int number1 = scanner.nextInt(); // you want to read an integer, so use nextInt()

		System.out.println("Enter Number2: ");
		int number2 = scanner.nextInt(); // you want to read an integer, so use nextInt()
